...
static const u8 ALIGN_DATA icon_s[] = {
	...
	0x00,0x65,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x15,0x00,0x00,0x00,0x00,0x00
};

static const int ALIGN_DATA icon_s_pos[NUM_FONTS] = {
	0x000000,0x0000d8,0x000188,0x00021e,0x0002c0,0x000365,0x0003e9,0x00047f,0x00050b,0x00058d,0x000623,0x0006bd,0x000757,0x0007f1
};

static const s8 ALIGN_DATA icon_s_width[NUM_FONTS] = {
	24,22,20,18,22,22,20,20,20,20,22,22,22,22
};

static const s8 ALIGN_DATA icon_s_height[NUM_FONTS] = {
	18,16,15,18,15,12,15,14,13,15,14,14,14,14
};

static const s8 ALIGN_DATA icon_s_skipx[NUM_FONTS] = {
	 0, 1, 2, 3, 1, 1, 2, 2, 2, 3, 1, 1, 1, 1
};

static const s8 ALIGN_DATA icon_s_skipy[NUM_FONTS] = {
	 0, 1, 1, 0, 2, 3, 2, 2, 3, 2, 2, 2, 2, 2
};
