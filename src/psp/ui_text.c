...
static const char *text[3][UI_TEXT_MAX] =
{
	...
	/*LANG_SPANISH*/
	{
		...
		"Regregar al menu principal/juego",
...
#endif
		"Re-iniciar emulacion",
		"Re-iniciar emulacion " SYSTEM_NAME ".",
		"Regresar al explorador de archivos",
		...
		"Tipo de la imagen de fondo",
		"Brillo de la imagen de fondo",
		...
		/* driver.c */
#ifdef ADHOC
		"Envidando datos EEPROM.\n",
		"Reciviendo datos EEPROM.\n",
#endif
