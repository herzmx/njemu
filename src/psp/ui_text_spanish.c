static const char *text_SPANISH[UI_TEXT_MAX] =
{
		...
		"Error al cargar los módulos AdHoc.",
#endif
		...
		/* psp/ui.c */
		"Advertencia: Batería baja (%d%%). Cargue la batería!",

		FONT_CIRCLE " para iniciar, " FONT_CROSS " para cancelar",
		FONT_CIRCLE " para confirmar, " FONT_CROSS " para cancelar",
#ifdef SAVE_STATE
		FONT_CIRCLE " regresar al juego, " FONT_CROSS " regresar al menú",
#endif
		"Pulse cualquier botón.",
		"Iniciar emulación.",
#ifdef ADHOC
		"Iniciar emulación. (AdHoc)",
#endif
		"Salir del emulador.",
		"Re-iniciar emulación.",
		"Necesita re-iniciar la emulación.",
#if (EMU_SYSTEM != NCDZ)
		...
		"Mostrar menú de configuración de color",
		"Mostrar esta ayuda",
		"Boot BIOS",
		...
		"Desplazamiento/Seleccionar ítem",
		"Abrir/Cerrar ítem del menú",
		...
		"Cambiar configuración de botones y auto disparo/hotkey.",
#if (EMU_SYSTEM != NCDZ)
		"Configuración de interruptores DIP",
		"Cambiar configuración de interruptores hardware DIP.",
#endif
		"Re-iniciar emulación",
		"Re-iniciar " SYSTEM_NAME " emulación.",
		"Regresar al explorador de archivos",
		"Detener emulación y regresar al explorador de archivos.",
		"Regresar al juego",
		"Regresar a la emulación del juego.",
		"Salir del emulador",
		"Salir de la emulación y regresar al menú del PSP.",
#ifdef COMMAND_LIST
		...
		"BIOS no encontrada.",
		"Seleccione la BIOS y presione el botón " FONT_CIRCLE ".",
