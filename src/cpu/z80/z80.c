...
void z80_init(void)
{
	...
	{
		Cz80_Set_Encrypt_Range(&CZ80, 0x0000, 0x8000, (u32)memory_region_user2);
	}
...
void z80_set_reg(int regnum, u32 val)
{
	switch (regnum)
	{
...
STATE_SAVE( z80 )
{
	u32 pc = Cz80_Get_Reg(&CZ80, CZ80_PC);
