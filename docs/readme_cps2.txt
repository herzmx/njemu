----------------------------------------------------------------------
                 ...
                 CAPCOM CPS2 Emulator for PSP 1.30
...
キャッシュファイルについて(※1.30で少し変更)
  ...
  cahceフォルダにgamename_cache(例:ssf2_cache)という名前のフォルダを
  作成し、romcnv_cps2.exeで作成したキャッシュに含まれるファイルを全て
  展開してください。メモリスティックの容量は減りますが、MVCなどでも
  ラグ無しでプレイ可能になるようです。
