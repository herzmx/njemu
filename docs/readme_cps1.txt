----------------------------------------------------------------------
                 ...
                 CAPCOM CPS1 Emulator for PSP 1.66
...
bootleg版のゲームの扱いについて
  ...
  ※ 1.65より、コンパイルオプションの変更を置こうなうことにより、
     一部ゲームのみプレイ可能としましたが、これらを有効にしたバイナリ
     は個人での使用にとどめ、配布しないでください。
...
----------------------------------------------------------------------
1.65
・makefileのRELEASEフラグを有効にした時のみ、いくつかのbootleg setが
  動作するように変更。
...
----------------------------------------------------------------------
1.63
・メモリ解放時にフリーズするバグが1.60あたりで混入していたので修正。
・スクロール2のフォアグラウンドレイヤーが正しく描画できていなかった
  バグを修正。これも1.60あたりからのバグと思われます。
